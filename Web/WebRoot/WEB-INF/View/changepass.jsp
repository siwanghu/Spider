			...
			<div class="bloc">
				...
				<div class="content">
					...
					<div class="input">
						...
						<input type="text" id="input1" readonly="readonly"  placeholder="请在此输入您的真实姓名"/>
					</div>
					<div class="input">
						<label for="personid">旧密码</label>
						<input type="text" id="personid"  placeholder="请在此输入您的旧密码"/>
					</div>
					<div class="input">
						<label for="personid">新密码</label>
						<input type="text" id="personid"  placeholder="请输入您的新密码"/>
					</div>
					<div class="input">
						<label for="personid">确认密码</label>
						<input type="text" id="personid"  placeholder="请再次输入您的新密码"/>
					<br />
					</div>
					<div class="submit">
