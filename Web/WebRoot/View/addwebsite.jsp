...
<html>
	...
	<body>
		...
		<div id="content" class="white">
			<h1><img src="img/icons/posts.png" alt="" />网站添加</h1>
	
			<div class="bloc">
				<div class="title">
					网站添加
				</div>
				<form method="post"  action="/Web/AddWebSiteControler.do">
				<div class="content">

					<div class="input">
						<label for="input1">省份</label>
						<input type="text"  id="input1"  value="" name="province"/>
						<label for="personid">市级</label>
						<input type="text"  id="personid"  value="" name="city"/>
		
					</div>

					<div class="input">
						<label for="input2">网址</label>
						<input type="text"  id="input2" value="" name="url"/>
